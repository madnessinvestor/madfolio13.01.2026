  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/debank" component={DebankPage} />
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (response: any) => {
      ...
      toast({
        ...
        description: `${response?.stats?.assets || 0} ativos, ${
          response?.stats?.wallets || 0
        } carteiras sincronizadas.`,
      });
          ...
          <header className="flex items-center justify-between gap-4 p-3 border-b bg-background sticky top-0 z-50">
            ...
            <div className="flex items-center gap-3">
                ...
                {isBalanceHidden ? (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-4.803m5.604-1.888A3.375 3.375 0 1015.75 10.5M9.879 16.121A3 3 0 1015.75 10.5"
                    />
                  </svg>
                )}
              </button>
              ...
              <div className="flex items-center gap-2 pl-2 border-l">
                <Avatar
                  className="h-8 w-8"
                  data-testid="avatar-madnessinvestor"
                >
                  <AvatarImage
                    src="/madnessinvestor-profile.png"
                    alt="madnessinvestor"
                  />
